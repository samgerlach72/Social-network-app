...
class LoadFollowersLambda {
    constructor() {
        this.handler = (json) => __awaiter(this, void 0, void 0, function* () {
            ...
            let event;
            if (!!json.lastItem) {
                event = new tweeter_shared_1.LoadMoreItemsRequest(tweeter_shared_1.AuthToken.fromJson(JSON.stringify(json.authToken)), tweeter_shared_1.User.fromJson(JSON.stringify(json.user)), json.pageSize, tweeter_shared_1.User.fromJson(JSON.stringify(json === null || json === void 0 ? void 0 : json.lastItem)));
            }
            else {
